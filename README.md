# Digyl
An application for Android that allows users to set handwashing and/or mask wearing reminders for entering or exiting certain locations.  
An iOS version is possible but not planned for at the moment.
